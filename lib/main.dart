...
//TODO: Add calling flutterfire configure
import 'package:vertex_test/firebase_options.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: !auth
          ...
          : const ChatScreen(title: 'Flutter + Vertex AI'),
    );
  }
}
...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  void initState() {
    ...
    initFirebase().then((value) {
      ...
      _functionCallModel = FirebaseVertexAI.instanceFor(
        auth: FirebaseAuth.instance,
        appCheck: FirebaseAppCheck.instance,
      ).generativeModel(
        model: 'gemini-1.5-flash-preview-0514',
